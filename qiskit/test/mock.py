...
from qiskit.providers.models import (BackendProperties, GateConfig,
                                     ...
                                     PulseDefaults, Command, UchannelLO, CmdDefPulseQobjInstruction)
    ...
    def __init__(self):
        ...
        self._defaults = PulseDefaults(
            ...
            cmd_def=[Command(name='u1', qubits=[0],
                             sequence=[CmdDefPulseQobjInstruction(name='fc', ch='d0',
                                                                  t0=0, phase='-P1*np.pi')]),
                     Command(name='cx', qubits=[0, 1],
                             sequence=[CmdDefPulseQobjInstruction(name='test_pulse_1',
                                                                  ch='d0', t0=0),
                                       CmdDefPulseQobjInstruction(name='test_pulse_2',
                                                                  ch='u0', t0=10),
                                       CmdDefPulseQobjInstruction(name='pv', ch='d1',
                                                                  t0=2, val='cos(P2)'),
                                       CmdDefPulseQobjInstruction(name='test_pulse_1',
                                                                  ch='d1', t0=20),
                                       CmdDefPulseQobjInstruction(name='fc', ch='d1',
                                                                  t0=20, phase=2.1)]),
                     Command(name='measure', qubits=[0],
                             sequence=[CmdDefPulseQobjInstruction(name='test_pulse_1',
                                                                  ch='m0', t0=0),
                                       CmdDefPulseQobjInstruction(name='acquire', duration=10, t0=0,
